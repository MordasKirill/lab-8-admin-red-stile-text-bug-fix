...
public class NewMessageServlet extends ChatServlet
{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
	{
		...
		ChatMessage message = new ChatMessage((String)req.getSession().getAttribute("username"), req.getParameter("message"), Calendar.getInstance().getTimeInMillis(), req.getParameter("person"), Calendar.getInstance().getTime());
